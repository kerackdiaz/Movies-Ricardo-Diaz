...
<div class="w-1/2 dark:text-white text-black">
  ...
  <table>
      ...
      <button onclick="addToFavorites()" class="bg-indigo-500 text-white px-4 py-2 rounded h-1/2 hover:scale-90"> <span><i class="fa-solid fa-heart-circle-plus "></i> Add to Favorites</button>
...
function shareOnTwitter() {
    window.open(`https://twitter.com/intent/tweet?url=${movieURL}&text=¡Mira esta película!`, '_blank', popupOptions);
  }
